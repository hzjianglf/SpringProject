...
<body>
<div class="tables_title">修改角色</div>
<form action="${ctx }/role/modify" id="form1" method="post">
 <input type="hidden" name="id" value="${roleinfo.id }"></input>
<div class="dengji_table">
    	<div class="basic_table">
            <div class="clospan">
            	<p class="basic_name">名称</p>
            	<p>
            	<input name="roleName"  id="roleName" type="text" class="easyui-validatebox"  data-options="required:true" value="${roleinfo.roleName}"/>
            	</p>
             </div>
         </div>
