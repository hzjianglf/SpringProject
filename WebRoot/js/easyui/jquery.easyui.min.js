...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"此处不允许为空.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
},message:"请输入合法的email地址."},url:{validator:function(_409){
...
},message:"请输入合法的URL."},length:{validator:function(_40a,_40b){
var len=$.trim(_40a).length;
return len>=_40b[0]&&len<=_40b[1];
},message:"请输入一个介于 {0} 到 {1}之间的值."},remote:{validator:function(_40c,_40d){
var data={};
data[_40d[1]]=_40c;
