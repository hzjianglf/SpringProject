...
var abcccccA = function(iterable) {
	var nArray = [];
...
function abccccc() {
	if (arguments.length == 1) return getabccccc(arguments[0]);
	var elements = [];
	abcccccc(arguments).each(function(el){
		elements.push(getabccccc(el));
	});
	return elements;

	function getabccccc(el){
